    ...
    <div className="my-8">
      <div className="max-w-lg rounded overflow-hidden shadow-lg bg-gray-200 mx-auto">
          <div className="flex items-center justify-between">
            <h1 className="font-bold px-6 py-4 text-xl mb-2">{courseName}</h1>
            <button title="Download Course PDF" className="bg-transparent hover:bg-blue-500 text-red-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded flex items-center mr-2"><span>Download </span><span><FaFilePdf></FaFilePdf></span></button>
          </div>
